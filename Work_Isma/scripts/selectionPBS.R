...
# Convert 1 to 0.9999
sch_trogl$FST[sch_trogl$FST == 1] = 0.99
sch_verus$FST[sch_verus$FST == 1] = 0.99
trogl_verus$FST[trogl_verus$FST == 1] = 0.99
...
write.table(PBS_relevant, file="PBSrelevant.txt", row.names=FALSE, col.names=FALSE)
