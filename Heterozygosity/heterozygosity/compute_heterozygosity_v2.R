setwd("/home/mjq483/exam/Chimp_Selection-popgen2018/Heterozygosity/heterozygosity/")
...
barplot(val,ylim=c(0.000,0.000008), ylab="pi", xlab="Population",
